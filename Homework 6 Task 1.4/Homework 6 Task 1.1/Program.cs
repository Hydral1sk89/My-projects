...
namespace Homework_6_Task_1._1
{
    class Program
    {
        ...
        /// <summary>
        /// Метод принимает число N (количество цифр хакатона) и возвращает количество групп
        /// </summary>
        /// <param name="quantity">число N</param>
        /// <returns></returns>
        public static int GetM(int quantity)
        {
            int group = 0;
        ...
        /// <summary>
        /// Метод загружает из файла количество чисел N и возвращает int значение
        /// </summary>
        /// <param name="path">путь к файлу</param>
        /// <returns></returns>
        static public int ReadQuantiyN(string path)
        {
            string file;

            file = File.ReadAllText(path);

            int n = Convert.ToInt32(file);
        ...
        /// <summary>
        /// Метод записывает в файл по пути path новое значение N
        /// </summary>
        /// <param name="quantityN">число N</param>
        static public void NewFile(int quantityN)
        {
            using (StreamWriter sw = new StreamWriter(path, true, Encoding.Unicode))
            {
                string note = Convert.ToString(quantityN);
                sw.Write(note);
            }
        }
                    ...
                    case 11:
                        {
                            ...
                            Console.WriteLine("Введите новое число N (от 1 до 1_000_000_000)");
